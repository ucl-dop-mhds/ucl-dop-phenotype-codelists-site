# ==============================================================================
# Generate code lists for Lipid Regulating Meds 
...
# 
# Final Outputs:
# 1) Code_Lists/Lipid_Regulating_Meds/Aurum_Lipid_Regulating_Meds_codelist_20260408.txt: Updated Aurum Lipid regulating meds code list
# 2) Code_Lists/Lipid_Regulating_Meds/Gold_Lipid_Regulating_Meds_codelist_20260408.txt: Updated GOLD Lipid regulating meds code list
...
path_output <- "Code_Lists/Lipid_Regulating_Meds/"
...
path_output <- "SMI_GLP/Code_Lists/Lipid_Regulating_Meds/"
...
aurum_codelist <- match_meds_2(df = aurum_matches_df, 
                               medication_field = "Lipid regulating meds", 
...
write.table(aurum_codelist, 
            file = paste0(wd, path_output, "Aurum_Lipid_Regulating_Meds_codelist_20260408.txt"),
            sep = "\t", row.names = FALSE)
...
write.table(gold_codelist, 
            file = paste0(wd, path_output, "Gold_Lipid_Regulating_Meds_codelist_20260408.txt"),
            sep = "\t", row.names = FALSE)
