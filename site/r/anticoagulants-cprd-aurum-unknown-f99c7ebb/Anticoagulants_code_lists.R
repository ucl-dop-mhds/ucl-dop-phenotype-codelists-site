# ==============================================================================
# Generate code lists for Anticoagulants 
...
# 
# Final Outputs:
# 1) Code_Lists/Anticoagulants/Aurum_Anticoagulants_codelist_20260320.txt: Updated Aurum Anticoagulants code list
# 2) Code_Lists/Anticoagulants/Gold_Anticoagulants_codelist_20260320.txt: Updated GOLD Anticoagulants code list
...
path_output <- "Code_Lists/Anticoagulants/"
...
path_output <- "SMI_GLP/Code_Lists/Anticoagulants/"
...
aurum_codelist <- match_meds_2(df = aurum_matches_df, 
                               medication_field = "Anticoagulants", 
...
# # Save as text file
 write.table(aurum_codelist, 
            file = paste0(wd, path_output, "Aurum_Anticoagulants_codelist_20260320.txt"),
            sep = "\t", row.names = FALSE)
 ...
 # # Save as text file
  write.table(gold_codelist, 
             file = paste0(wd, path_output, "Gold_Anticoagulants_codelist_20260320.txt"),
              sep = "\t", row.names = FALSE)
