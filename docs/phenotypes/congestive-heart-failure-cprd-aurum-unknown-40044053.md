...
<p class="phenotype-subtitle">Code name: <code>congestive-heart-failure</code></p>
...
## Raw metadata
```yaml
id: congestive-heart-failure-cprd-aurum-unknown-40044053
title: Congestive Heart Failure
display_name: Congestive Heart Failure
code_name: congestive_heart_failure
