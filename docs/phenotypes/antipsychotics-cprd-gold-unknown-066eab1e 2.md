...
## Raw metadata
```yaml
id: antipsychotics-cprd-gold-unknown-066eab1e
...
description: 'Auto-ingested from smwu/SMI_GLP (main) at 1e3dfaacd5ed63663138e764d88792609878a84e.
  Source path: Code_Lists/Antipsychotics/Gold_Antipsychotics_codelist_20250801.txt.'
version: 0.1.0
status: draft
coding_systems:
- system: Unknown
