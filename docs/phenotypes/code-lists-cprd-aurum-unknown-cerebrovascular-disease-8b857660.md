...
**Code name:** `cerebrovascular-disease`  
**ID:** `code-lists-cprd-aurum-unknown-cerebrovascular-disease-8b857660`  
**Status:** `draft`  
**Version:** `0.1.0`  
...
## Downloads
- [Download codelist CSV](../csv/code-lists-cprd-aurum-unknown-cerebrovascular-disease-8b857660.csv)
