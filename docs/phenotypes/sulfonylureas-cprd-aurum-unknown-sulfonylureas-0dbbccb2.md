...
**Display name:** `Sulfonylureas`  
**Dataset type:** `CPRD Aurum`  
**Code name:** `sulfonylureas`  
**Group:** `Sulfonylureas`  
**ID:** `sulfonylureas-cprd-aurum-unknown-sulfonylureas-0dbbccb2`  
**Status:** `draft`  
**Version:** `0.1.0`  
...
## Description
Auto-ingested from smwu/SMI_GLP (main) at 1e3dfaacd5ed63663138e764d88792609878a84e. Source path: code_lists/Sulfonylureas/Aurum_Sulfonylureas_codelist_20250730.txt.

## Downloads
- [Download codelist CSV](../csv/sulfonylureas-cprd-aurum-unknown-sulfonylureas-0dbbccb2.csv)
- [Download R script: 0d_Sulfonylureas_code_list.R](../r/sulfonylureas-cprd-aurum-unknown-sulfonylureas-0dbbccb2/0d_Sulfonylureas_code_list.R)
