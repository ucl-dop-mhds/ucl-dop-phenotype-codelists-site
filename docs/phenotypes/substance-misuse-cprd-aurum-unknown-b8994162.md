...
<p class="phenotype-subtitle">Code name: <code>substance-misuse</code></p>
...
## Raw metadata
```yaml
id: substance-misuse-cprd-aurum-unknown-b8994162
title: Substance Misuse
display_name: Substance Misuse
