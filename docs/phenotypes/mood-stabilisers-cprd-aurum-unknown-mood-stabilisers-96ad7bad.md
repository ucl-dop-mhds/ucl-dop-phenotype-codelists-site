...
**Display name:** `Mood Stabilisers`  
**Dataset type:** `CPRD Aurum`  
**Code name:** `mood-stabilisers`  
**Group:** `Mood_Stabilisers`  
**ID:** `mood-stabilisers-cprd-aurum-unknown-mood-stabilisers-96ad7bad`  
**Status:** `draft`  
**Version:** `0.1.0`  
...
## Description
Auto-ingested from smwu/SMI_GLP (main) at 1e3dfaacd5ed63663138e764d88792609878a84e. Source path: code_lists/Mood_Stabilisers/Aurum_Mood_Stabilisers_codelist_20250801.txt.

## Downloads
- [Download codelist CSV](../csv/mood-stabilisers-cprd-aurum-unknown-mood-stabilisers-96ad7bad.csv)
- [Download R script: 0l_Mood_Stabilisers_code_list.R](../r/mood-stabilisers-cprd-aurum-unknown-mood-stabilisers-96ad7bad/0l_Mood_Stabilisers_code_list.R)
