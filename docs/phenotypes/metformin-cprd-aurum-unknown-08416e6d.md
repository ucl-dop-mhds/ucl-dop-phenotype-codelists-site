...
## Raw metadata
```yaml
id: metformin-cprd-aurum-unknown-08416e6d
title: Metformin
display_name: Metformin
code_name: metformin
phenotype_group: Metformin
description: 'Auto-ingested from smwu/SMI_GLP (main) at 1e3dfaacd5ed63663138e764d88792609878a84e.
  Source path: Code_Lists/Metformin/Aurum_Metformin_codelist_20250801.txt.'
version: 0.1.0
status: draft
coding_systems:
- system: Unknown
