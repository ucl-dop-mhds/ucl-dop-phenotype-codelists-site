...
**Code name:** `myocardial-infarction`  
**ID:** `code-lists-cprd-aurum-unknown-myocardial-infarction-26df1d22`  
**Status:** `draft`  
**Version:** `0.1.0`  
...
## Downloads
- [Download codelist CSV](../csv/code-lists-cprd-aurum-unknown-myocardial-infarction-26df1d22.csv)

## Description
Auto-ingested from NaomiLaunders/Repurposing-statins-in-SMI (main) at 55a86d5fcf8e8cb851419ea126e9563b69ed1135. Source path: Code lists/MIAurum.txt.
