...
<h2>Antidiabetics</h2>
<p class="phenotype-subtitle">Code name: <code>antidiabetics</code></p>
...
## Raw metadata
```yaml
id: antidiabetics-cprd-gold-unknown-073d10f7
title: Antidiabetics
display_name: Antidiabetics
code_name: antidiabetics
phenotype_group: Antidiabetics
description: 'Auto-ingested from smwu/SMI_GLP (main) at 1e3dfaacd5ed63663138e764d88792609878a84e.
  Source path: Code_Lists/Antidiabetics/Gold_Antidiabetics_prodcode_codelist_20251027.txt.'
version: 0.1.0
status: draft
coding_systems:
- system: Unknown
