...
<div><strong>ID (phenotype-githubID-repoStart):</strong> <code>antidiabetics-smwu-smi</code></div>
...
<div class="metadata-detail-row"><span class="meta-star meta-star-9">★</span> <strong>Brief phenotype description and usage:</strong> Auto-ingested from smwu/SMI_GLP (main) at 1e3dfaacd5ed63663138e764d88792609878a84e. Source path: Code_Lists/Antidiabetics/Gold_Antidiabetics_prodcode_codelist_20251027.txt.</div>
</div>
