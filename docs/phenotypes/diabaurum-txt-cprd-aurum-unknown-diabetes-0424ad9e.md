...
**Code name:** `diabetes`  
**Group:** `DiabAurum.txt`  
**ID:** `diabaurum-txt-cprd-aurum-unknown-diabetes-0424ad9e`  
**Status:** `draft`  
**Version:** `0.1.0`  
...
## Description
Auto-ingested from NaomiLaunders/Repurposing-statins-in-SMI (main) at 55a86d5fcf8e8cb851419ea126e9563b69ed1135. Source path: Code lists/DiabAurum.txt.

## Downloads
- [Download codelist CSV](../csv/diabaurum-txt-cprd-aurum-unknown-diabetes-0424ad9e.csv)
