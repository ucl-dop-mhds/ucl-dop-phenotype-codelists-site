...
<h2>Psychotropics</h2>
<p class="phenotype-subtitle">Code name: <code>psychotropics</code></p>
...
## Raw metadata
```yaml
id: psychotropics-cprd-gold-unknown-7a412366
title: Psychotropics
display_name: Psychotropics
code_name: psychotropics
phenotype_group: Psychotropics
description: 'Auto-ingested from smwu/SMI_GLP (main) at 1e3dfaacd5ed63663138e764d88792609878a84e.
  Source path: Code_Lists/Psychotropics/Gold_Psychotropics_codelist_20250819.txt.'
version: 0.1.0
status: draft
coding_systems:
- system: Unknown
