...
<p class="phenotype-subtitle">Code name: <code>mood-stabilisers</code></p>
...
## Raw metadata
```yaml
id: mood-stabilisers-cprd-aurum-unknown-1b669bf3
title: Mood Stabilisers
display_name: Mood Stabilisers
code_name: mood-stabilisers
phenotype_group: Mood_Stabilisers
description: 'Auto-ingested from smwu/SMI_GLP (main) at 1e3dfaacd5ed63663138e764d88792609878a84e.
  Source path: Code_Lists/Mood_Stabilisers/Aurum_Mood_Stabilisers_codelist_20250801.txt.'
version: 0.1.0
status: draft
coding_systems:
- system: Unknown
