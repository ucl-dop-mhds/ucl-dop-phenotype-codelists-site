...
**Display name:** `Bmigoldtxt Bmigold`  
**Dataset type:** `Unknown`  
**Code name:** `bmigoldtxt-bmigold`  
**Group:** `BMIGold.txt`  
**ID:** `bmigold-txt-unknown-unknown-bmigoldtxt-bmigold-5e841f34`  
**Status:** `draft`  
**Version:** `0.1.0`  
...
## Description
Auto-ingested from NaomiLaunders/Repurposing-statins-in-SMI (main) at 55a86d5fcf8e8cb851419ea126e9563b69ed1135. Source path: Code lists/BMIGold.txt.

## Downloads
- [Download codelist CSV](../csv/bmigold-txt-unknown-unknown-bmigoldtxt-bmigold-5e841f34.csv)
...
```yaml
id: bmigold-txt-unknown-unknown-bmigoldtxt-bmigold-5e841f34
title: Bmigoldtxt Bmigold
display_name: Bmigoldtxt Bmigold
code_name: bmigoldtxt-bmigold
phenotype_group: BMIGold.txt
description: 'Auto-ingested from NaomiLaunders/Repurposing-statins-in-SMI (main) at
  55a86d5fcf8e8cb851419ea126e9563b69ed1135. Source path: Code lists/BMIGold.txt.'
version: 0.1.0
status: draft
coding_systems:
- system: Unknown
