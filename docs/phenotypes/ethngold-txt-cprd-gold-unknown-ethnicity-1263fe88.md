...
**Code name:** `ethnicity`  
**Group:** `EthnGold.txt`  
**ID:** `ethngold-txt-cprd-gold-unknown-ethnicity-1263fe88`  
**Status:** `draft`  
**Version:** `0.1.0`  
...
## Description
Auto-ingested from NaomiLaunders/Repurposing-statins-in-SMI (main) at 55a86d5fcf8e8cb851419ea126e9563b69ed1135. Source path: Code lists/EthnGold.txt.

## Downloads
- [Download codelist CSV](../csv/ethngold-txt-cprd-gold-unknown-ethnicity-1263fe88.csv)
