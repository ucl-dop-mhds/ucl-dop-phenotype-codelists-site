...
**Code name:** `final-smicodes`  
**ID:** `code-lists-cprd-gold-unknown-final-smicodes-a7bec094`  
**Status:** `draft`  
**Version:** `0.1.0`  
...
## Downloads
- [Download codelist CSV](../csv/code-lists-cprd-gold-unknown-final-smicodes-a7bec094.csv)
...
```yaml
id: code-lists-cprd-gold-unknown-final-smicodes-a7bec094
title: Final Smicodes
display_name: Final Smicodes
code_name: final-smicodes
