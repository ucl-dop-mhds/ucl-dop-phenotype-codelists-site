...
## Raw metadata
```yaml
id: cerebrovascular-disease-cprd-aurum-unknown-d5fcd383
title: Cerebrovascular Disease
display_name: Cerebrovascular Disease
code_name: cerebrovascular_disease
