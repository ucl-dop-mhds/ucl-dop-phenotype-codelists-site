...
<h2>SGLT2is</h2>
<p class="phenotype-subtitle">Code name: <code>sglt2is</code></p>
...
## Raw metadata
```yaml
id: sglt2is-cprd-aurum-unknown-ce59adc0
title: SGLT2is
display_name: SGLT2is
code_name: sglt2is
phenotype_group: SGLT2is
description: 'Auto-ingested from smwu/SMI_GLP (main) at 1e3dfaacd5ed63663138e764d88792609878a84e.
  Source path: Code_Lists/SGLT2is/Aurum_SGLT2is_codelist_20250801.txt.'
version: 0.1.0
status: draft
coding_systems:
- system: Unknown
