...
## Raw metadata
```yaml
id: depression-cprd-aurum-unknown-d9211afb
title: Depression
...
description: 'Auto-ingested from smwu/SMI_GLP (main) at 1e3dfaacd5ed63663138e764d88792609878a84e.
  Source path: Code_Lists/Depression/Aurum_Depression_codelist_20250725.txt.'
version: 0.1.0
status: draft
coding_systems:
- system: Unknown
