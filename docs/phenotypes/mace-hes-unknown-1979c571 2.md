...
<p class="phenotype-kicker">HES phenotype</p>
<h2>MACE</h2>
<p class="phenotype-subtitle">Code name: <code>mace</code></p>
...
## Raw metadata
```yaml
id: mace-hes-unknown-1979c571
title: MACE
display_name: MACE
code_name: mace
phenotype_group: MACE
description: 'Auto-ingested from smwu/SMI_GLP (main) at 1e3dfaacd5ed63663138e764d88792609878a84e.
  Source path: Code_Lists/MACE/MACE_codelist_20250929.txt.'
version: 0.1.0
status: draft
coding_systems:
- system: Unknown
