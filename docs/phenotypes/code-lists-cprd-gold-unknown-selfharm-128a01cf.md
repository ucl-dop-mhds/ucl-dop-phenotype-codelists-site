...
**Code name:** `selfharm`  
**ID:** `code-lists-cprd-gold-unknown-selfharm-128a01cf`  
**Status:** `draft`  
**Version:** `0.1.0`  
...
## Downloads
- [Download codelist CSV](../csv/code-lists-cprd-gold-unknown-selfharm-128a01cf.csv)

## Description
Auto-ingested from NaomiLaunders/Repurposing-statins-in-SMI (main) at 55a86d5fcf8e8cb851419ea126e9563b69ed1135. Source path: Code lists/SelfHarmGold.txt.
...
description: 'Auto-ingested from NaomiLaunders/Repurposing-statins-in-SMI (main) at
  55a86d5fcf8e8cb851419ea126e9563b69ed1135. Source path: Code lists/SelfHarmGold.txt.'
version: 0.1.0
status: draft
coding_systems:
- system: Unknown
