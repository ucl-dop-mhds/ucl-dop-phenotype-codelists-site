...
## Raw metadata
```yaml
id: mood-stabilisers-cprd-gold-unknown-891ea9a1
...
description: 'Auto-ingested from smwu/SMI_GLP (main) at 1e3dfaacd5ed63663138e764d88792609878a84e.
  Source path: Code_Lists/Mood_Stabilisers/Gold_Mood_Stabilisers_codelist_20250801.txt.'
version: 0.1.0
status: draft
coding_systems:
- system: Unknown
