...
## Raw metadata
```yaml
id: antipsychotics-cprd-aurum-unknown-06a3685f
...
description: 'Auto-ingested from NaomiLaunders/Repurposing-statins-in-SMI (main) at
  55a86d5fcf8e8cb851419ea126e9563b69ed1135. Source path: Code lists/APAurum.txt.'
version: 0.1.0
status: draft
coding_systems:
- system: Unknown
