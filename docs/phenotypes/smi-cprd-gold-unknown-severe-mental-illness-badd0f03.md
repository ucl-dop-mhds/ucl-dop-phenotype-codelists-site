...
**Display name:** `Severe Mental Illness`  
**Dataset type:** `CPRD Gold`  
**Code name:** `severe-mental-illness`  
**Group:** `SMI`  
**ID:** `smi-cprd-gold-unknown-severe-mental-illness-badd0f03`  
**Status:** `draft`  
**Version:** `0.1.0`  
...
## Description
Auto-ingested from smwu/SMI_GLP (main) at 1e3dfaacd5ed63663138e764d88792609878a84e. Source path: code_lists/SMI/Gold_SMI_codelist_20250725.txt.

## Downloads
- [Download codelist CSV](../csv/smi-cprd-gold-unknown-severe-mental-illness-badd0f03.csv)
- [Download R script: 0a_SMI_code_list.R](../r/smi-cprd-gold-unknown-severe-mental-illness-badd0f03/0a_SMI_code_list.R)
