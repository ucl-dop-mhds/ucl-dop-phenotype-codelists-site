...
<h2>Sulfonylureas</h2>
<p class="phenotype-subtitle">Code name: <code>sulfonylureas</code></p>
...
## Raw metadata
```yaml
id: sulfonylureas-cprd-aurum-unknown-4e0806ce
title: Sulfonylureas
display_name: Sulfonylureas
code_name: sulfonylureas
phenotype_group: Sulfonylureas
description: 'Auto-ingested from smwu/SMI_GLP (main) at 1e3dfaacd5ed63663138e764d88792609878a84e.
  Source path: Code_Lists/Sulfonylureas/Aurum_Sulfonylureas_codelist_20250730.txt.'
version: 0.1.0
status: draft
coding_systems:
- system: Unknown
