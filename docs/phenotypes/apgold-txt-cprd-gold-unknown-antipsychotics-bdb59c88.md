...
**Group:** `APGold.txt`  
**ID:** `apgold-txt-cprd-gold-unknown-antipsychotics-bdb59c88`  
**Status:** `draft`  
**Version:** `0.1.0`  
...
## Description
Auto-ingested from NaomiLaunders/Repurposing-statins-in-SMI (main) at 55a86d5fcf8e8cb851419ea126e9563b69ed1135. Source path: Code lists/APGold.txt.

## Downloads
- [Download codelist CSV](../csv/apgold-txt-cprd-gold-unknown-antipsychotics-bdb59c88.csv)
