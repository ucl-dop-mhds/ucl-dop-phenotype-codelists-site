...
<h2>Other Antidiabetics</h2>
<p class="phenotype-subtitle">Code name: <code>other-antidiabetics</code></p>
...
## Raw metadata
```yaml
id: other-antidiabetics-cprd-aurum-unknown-a50515fe
title: Other Antidiabetics
display_name: Other Antidiabetics
...
description: 'Auto-ingested from smwu/SMI_GLP (main) at 1e3dfaacd5ed63663138e764d88792609878a84e.
  Source path: Code_Lists/Other_Antidiabetics/Aurum_Other_Antidiabetics_codelist_20250801.txt.'
version: 0.1.0
status: draft
coding_systems:
- system: Unknown
