...
**Display name:** `Migoldtxt Migold`  
**Dataset type:** `Unknown`  
**Code name:** `migoldtxt-migold`  
**Group:** `MIGold.txt`  
**ID:** `migold-txt-unknown-unknown-migoldtxt-migold-0144679f`  
**Status:** `draft`  
**Version:** `0.1.0`  
...
## Description
Auto-ingested from NaomiLaunders/Repurposing-statins-in-SMI (main) at 55a86d5fcf8e8cb851419ea126e9563b69ed1135. Source path: Code lists/MIGold.txt.

## Downloads
- [Download codelist CSV](../csv/migold-txt-unknown-unknown-migoldtxt-migold-0144679f.csv)
...
```yaml
id: migold-txt-unknown-unknown-migoldtxt-migold-0144679f
title: Migoldtxt Migold
display_name: Migoldtxt Migold
code_name: migoldtxt-migold
phenotype_group: MIGold.txt
description: 'Auto-ingested from NaomiLaunders/Repurposing-statins-in-SMI (main) at
  55a86d5fcf8e8cb851419ea126e9563b69ed1135. Source path: Code lists/MIGold.txt.'
version: 0.1.0
status: draft
coding_systems:
- system: Unknown
