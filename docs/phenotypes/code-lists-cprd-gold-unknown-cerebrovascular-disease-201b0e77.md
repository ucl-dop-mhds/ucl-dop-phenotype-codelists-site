...
**ID:** `code-lists-cprd-gold-unknown-cerebrovascular-disease-201b0e77`  
**Status:** `draft`  
**Version:** `0.1.0`  
...
## Downloads
- [Download codelist CSV](../csv/code-lists-cprd-gold-unknown-cerebrovascular-disease-201b0e77.csv)
