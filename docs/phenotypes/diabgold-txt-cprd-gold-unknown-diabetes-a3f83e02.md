...
**Code name:** `diabetes`  
**Group:** `DiabGold.txt`  
**ID:** `diabgold-txt-cprd-gold-unknown-diabetes-a3f83e02`  
**Status:** `draft`  
**Version:** `0.1.0`  
...
## Description
Auto-ingested from NaomiLaunders/Repurposing-statins-in-SMI (main) at 55a86d5fcf8e8cb851419ea126e9563b69ed1135. Source path: Code lists/DiabGold.txt.

## Downloads
- [Download codelist CSV](../csv/diabgold-txt-cprd-gold-unknown-diabetes-a3f83e02.csv)
...
code_name: diabetes
phenotype_group: DiabGold.txt
description: 'Auto-ingested from NaomiLaunders/Repurposing-statins-in-SMI (main) at
  55a86d5fcf8e8cb851419ea126e9563b69ed1135. Source path: Code lists/DiabGold.txt.'
version: 0.1.0
status: draft
coding_systems:
- system: Unknown
