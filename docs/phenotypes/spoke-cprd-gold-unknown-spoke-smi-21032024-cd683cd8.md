...
**Display name:** `Spoke SMI 21032024`  
**Dataset type:** `CPRD Gold`  
**Code name:** `spoke-smi-21032024`  
**Group:** `spoke`  
**ID:** `spoke-cprd-gold-unknown-spoke-smi-21032024-cd683cd8`  
**Status:** `draft`  
**Version:** `0.1.0`  
...
## Description
Auto-ingested from Alvin-RB/antipsychotics_descriptive_study_cprd (main) at 6d9d6db995b4c0e30842a15fa942fbce6fd74507. Source path: GOLD_SMI_codelist_21032024.txt.

## Downloads
- [Download codelist CSV](../csv/spoke-cprd-gold-unknown-spoke-smi-21032024-cd683cd8.csv)
...
```yaml
id: spoke-cprd-gold-unknown-spoke-smi-21032024-cd683cd8
title: Spoke SMI 21032024
display_name: Spoke SMI 21032024
code_name: spoke-smi-21032024
phenotype_group: spoke
description: 'Auto-ingested from Alvin-RB/antipsychotics_descriptive_study_cprd (main)
  at 6d9d6db995b4c0e30842a15fa942fbce6fd74507. Source path: GOLD_SMI_codelist_21032024.txt.'
version: 0.1.0
status: draft
coding_systems:
- system: Unknown
