...
**ID:** `code-lists-cprd-aurum-unknown-severe-mental-illness-321600cf`  
**Status:** `draft`  
**Version:** `0.1.0`  
...
## Downloads
- [Download codelist CSV](../csv/code-lists-cprd-aurum-unknown-severe-mental-illness-321600cf.csv)
