...
<div><strong>ID (phenotype-githubID-repoStart):</strong> <code>severe-mental-illness-naomilaunders-repurposing</code></div>
...
<div class="metadata-detail-row"><span class="meta-star meta-star-9">★</span> <strong>Brief phenotype description and usage:</strong> Auto-ingested from NaomiLaunders/Repurposing-statins-in-SMI (main) at 55a86d5fcf8e8cb851419ea126e9563b69ed1135. Source path: Code lists/FinalAurumSMICodes.txt.</div>
</div>
