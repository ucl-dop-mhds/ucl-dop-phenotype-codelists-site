...
<h2>Alcohol Misuse</h2>
<p class="phenotype-subtitle">Code name: <code>alcohol-misuse</code></p>
...
## Raw metadata
```yaml
id: alcohol-misuse-cprd-aurum-unknown-3eb3fde8
title: Alcohol Misuse
display_name: Alcohol Misuse
code_name: alcohol-misuse
phenotype_group: Alcohol_Misuse
description: 'Auto-ingested from smwu/SMI_GLP (main) at 1e3dfaacd5ed63663138e764d88792609878a84e.
  Source path: Code_Lists/Alcohol_Misuse/Aurum_Gold_Alcohol_misuse_codelist_20260304.txt.'
version: 0.1.0
status: draft
coding_systems:
- system: Unknown
