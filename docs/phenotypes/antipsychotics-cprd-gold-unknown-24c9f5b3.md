...
## Raw metadata
```yaml
id: antipsychotics-cprd-gold-unknown-24c9f5b3
...
description: 'Auto-ingested from NaomiLaunders/Repurposing-statins-in-SMI (main) at
  55a86d5fcf8e8cb851419ea126e9563b69ed1135. Source path: Code lists/APGold.txt.'
version: 0.1.0
status: draft
coding_systems:
- system: Unknown
