...
**ID:** `code-lists-cprd-gold-unknown-congestive-heart-failure-a811e2d0`  
**Status:** `draft`  
**Version:** `0.1.0`  
...
## Downloads
- [Download codelist CSV](../csv/code-lists-cprd-gold-unknown-congestive-heart-failure-a811e2d0.csv)
