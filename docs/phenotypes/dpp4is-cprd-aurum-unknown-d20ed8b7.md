...
<h2>DPP4is</h2>
<p class="phenotype-subtitle">Code name: <code>dpp4is</code></p>
...
## Raw metadata
```yaml
id: dpp4is-cprd-aurum-unknown-d20ed8b7
title: DPP4is
display_name: DPP4is
code_name: dpp4is
phenotype_group: DPP4is
description: 'Auto-ingested from smwu/SMI_GLP (main) at 1e3dfaacd5ed63663138e764d88792609878a84e.
  Source path: Code_Lists/DPP4is/Aurum_DPP4is_codelist_20250801.txt.'
version: 0.1.0
status: draft
coding_systems:
- system: Unknown
