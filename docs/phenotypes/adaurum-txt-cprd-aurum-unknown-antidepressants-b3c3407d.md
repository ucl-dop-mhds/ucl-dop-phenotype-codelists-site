...
**Group:** `ADAurum.txt`  
**ID:** `adaurum-txt-cprd-aurum-unknown-antidepressants-b3c3407d`  
**Status:** `draft`  
**Version:** `0.1.0`  
...
## Description
Auto-ingested from NaomiLaunders/Repurposing-statins-in-SMI (main) at 55a86d5fcf8e8cb851419ea126e9563b69ed1135. Source path: Code lists/ADAurum.txt.

## Downloads
- [Download codelist CSV](../csv/adaurum-txt-cprd-aurum-unknown-antidepressants-b3c3407d.csv)
...
phenotype_group: ADAurum.txt
description: 'Auto-ingested from NaomiLaunders/Repurposing-statins-in-SMI (main) at
  55a86d5fcf8e8cb851419ea126e9563b69ed1135. Source path: Code lists/ADAurum.txt.'
version: 0.1.0
status: draft
coding_systems:
- system: Unknown
