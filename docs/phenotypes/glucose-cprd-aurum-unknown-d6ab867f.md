...
<h2>Glucose</h2>
<p class="phenotype-subtitle">Code name: <code>glucose</code></p>
...
## Raw metadata
```yaml
id: glucose-cprd-aurum-unknown-d6ab867f
title: Glucose
display_name: Glucose
code_name: glucose
phenotype_group: Glucose
description: 'Auto-ingested from smwu/SMI_GLP (main) at 1e3dfaacd5ed63663138e764d88792609878a84e.
  Source path: Code_Lists/Glucose/Aurum_Gold_Glucose_codelist_20260206.txt.'
version: 0.1.0
status: draft
coding_systems:
- system: Unknown
