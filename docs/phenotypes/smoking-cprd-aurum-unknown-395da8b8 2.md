...
<h2>Smoking</h2>
<p class="phenotype-subtitle">Code name: <code>smoking</code></p>
...
## Raw metadata
```yaml
id: smoking-cprd-aurum-unknown-395da8b8
title: Smoking
display_name: Smoking
code_name: smoking
phenotype_group: Smoking
description: 'Auto-ingested from smwu/SMI_GLP (main) at 1e3dfaacd5ed63663138e764d88792609878a84e.
  Source path: Code_Lists/Smoking/Aurum_Smoking_codelist_20260210.txt.'
version: 0.1.0
status: draft
coding_systems:
- system: Unknown
