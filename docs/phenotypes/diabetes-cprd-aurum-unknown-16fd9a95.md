...
## Raw metadata
```yaml
id: diabetes-cprd-aurum-unknown-16fd9a95
title: Diabetes
display_name: Diabetes
code_name: diabetes
phenotype_group: Code lists
description: 'Auto-ingested from NaomiLaunders/Repurposing-statins-in-SMI (main) at
  55a86d5fcf8e8cb851419ea126e9563b69ed1135. Source path: Code lists/DiabAurum.txt.'
version: 0.1.0
status: draft
coding_systems:
- system: Unknown
