...
**Code name:** `statin-med`  
**ID:** `code-lists-cprd-aurum-unknown-statin-med-60a6655a`  
**Status:** `draft`  
**Version:** `0.1.0`  
...
## Downloads
- [Download codelist CSV](../csv/code-lists-cprd-aurum-unknown-statin-med-60a6655a.csv)
