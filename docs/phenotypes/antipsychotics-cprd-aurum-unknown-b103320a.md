...
<p class="phenotype-subtitle">Code name: <code>antipsychotics</code></p>
...
## Raw metadata
```yaml
id: antipsychotics-cprd-aurum-unknown-b103320a
title: Antipsychotics
display_name: Antipsychotics
code_name: antipsychotics
phenotype_group: Antipsychotics
description: 'Auto-ingested from smwu/SMI_GLP (main) at 1e3dfaacd5ed63663138e764d88792609878a84e.
  Source path: Code_Lists/Antipsychotics/Aurum_Antipsychotics_codelist_20250801.txt.'
version: 0.1.0
status: draft
coding_systems:
- system: Unknown
