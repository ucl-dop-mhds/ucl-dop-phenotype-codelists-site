...
<h2>Height</h2>
<p class="phenotype-subtitle">Code name: <code>height</code></p>
...
## Raw metadata
```yaml
id: height-cprd-aurum-unknown-5745d356
title: Height
display_name: Height
code_name: height
