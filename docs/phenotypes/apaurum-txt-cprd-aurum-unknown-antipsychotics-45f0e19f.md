...
**Group:** `APAurum.txt`  
**ID:** `apaurum-txt-cprd-aurum-unknown-antipsychotics-45f0e19f`  
**Status:** `draft`  
**Version:** `0.1.0`  
...
## Description
Auto-ingested from NaomiLaunders/Repurposing-statins-in-SMI (main) at 55a86d5fcf8e8cb851419ea126e9563b69ed1135. Source path: Code lists/APAurum.txt.

## Downloads
- [Download codelist CSV](../csv/apaurum-txt-cprd-aurum-unknown-antipsychotics-45f0e19f.csv)
