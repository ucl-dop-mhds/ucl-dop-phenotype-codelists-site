...
## Raw metadata
```yaml
id: psychotropics-cprd-aurum-unknown-b2c6667f
title: Psychotropics
...
description: 'Auto-ingested from smwu/SMI_GLP (main) at 1e3dfaacd5ed63663138e764d88792609878a84e.
  Source path: Code_Lists/Psychotropics/Aurum_Psychotropics_codelist_20250819.txt.'
version: 0.1.0
status: draft
coding_systems:
- system: Unknown
