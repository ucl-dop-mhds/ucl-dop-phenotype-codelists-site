...
<h2>Statins</h2>
<p class="phenotype-subtitle">Code name: <code>statins</code></p>
...
## Raw metadata
```yaml
id: statins-cprd-aurum-unknown-9e9066d9
title: Statins
