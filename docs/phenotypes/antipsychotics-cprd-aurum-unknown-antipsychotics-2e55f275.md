...
**Display name:** `Antipsychotics`  
**Dataset type:** `CPRD Aurum`  
**Code name:** `antipsychotics`  
**Group:** `Antipsychotics`  
**ID:** `antipsychotics-cprd-aurum-unknown-antipsychotics-2e55f275`  
**Status:** `draft`  
**Version:** `0.1.0`  
...
## Description
Auto-ingested from smwu/SMI_GLP (main) at 1e3dfaacd5ed63663138e764d88792609878a84e. Source path: code_lists/Antipsychotics/Aurum_Antipsychotics_codelist_20250801.txt.

## Downloads
- [Download codelist CSV](../csv/antipsychotics-cprd-aurum-unknown-antipsychotics-2e55f275.csv)
- [Download R script: 0k_Antipsychotics_code_list.R](../r/antipsychotics-cprd-aurum-unknown-antipsychotics-2e55f275/0k_Antipsychotics_code_list.R)
