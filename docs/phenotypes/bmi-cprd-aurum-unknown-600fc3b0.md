...
<h2>BMI</h2>
<p class="phenotype-subtitle">Code name: <code>bmi</code></p>
...
## Raw metadata
```yaml
id: bmi-cprd-aurum-unknown-600fc3b0
title: BMI
display_name: BMI
code_name: bmi
