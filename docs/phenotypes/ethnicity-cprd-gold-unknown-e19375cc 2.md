...
<h2>Ethnicity</h2>
<p class="phenotype-subtitle">Code name: <code>ethnicity</code></p>
...
## Raw metadata
```yaml
id: ethnicity-cprd-gold-unknown-e19375cc
title: Ethnicity
...
description: 'Auto-ingested from NaomiLaunders/Repurposing-statins-in-SMI (main) at
  55a86d5fcf8e8cb851419ea126e9563b69ed1135. Source path: Code lists/EthnGold.txt.'
version: 0.1.0
status: draft
coding_systems:
- system: Unknown
