...
<ul class="phenotype-download-list"><li><a href="../csv/selfharm-cprd-gold-unknown-f7d53dec.csv">Download codelist CSV</a></li></ul>
...
## Raw metadata
```yaml
id: selfharm-cprd-gold-unknown-f7d53dec
title: Selfharm
