# ==============================================================================
# Generate code lists for antipsychotic medications
# Author: SM Wu
...
# 
# Final Outputs:
# 1) Code_Lists/Antipsychotics/Aurum_Antipsychotics_codelist_20250801.txt: Updated Aurum Antipsychotic code list
# 2) Code_Lists/Antipsychotics/Gold_Antipsychotics_codelist_20250801.txt: Updated GOLD Antipsychotic code list
# ==============================================================================
...
path_output <- "Code_Lists/Antipsychotics/"
...
aurum_codelist <- match_meds_2(df = aurum_matches_df, 
                               medication_field = "Antipsychotic", 
