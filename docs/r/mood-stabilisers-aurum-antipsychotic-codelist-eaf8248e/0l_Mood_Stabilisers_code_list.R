# ==============================================================================
# Generate code lists for mood-stabiliser medications
# Author: SM Wu
...
# 
# Final Outputs:
# 1) Code_Lists/Mood_Stabilisers/Aurum_Mood_Stabilisers_codelist_20250801.txt: Updated Aurum Mood Stabiliser code list
# 2) Code_Lists/Mood_Stabilisers/Gold_Mood_Stabilisers_codelist_20250801.txt: Updated GOLD Mood Stabiliser code list
# ==============================================================================
...
path_output <- "Code_Lists/Mood_Stabilisers/"
...
aurum_codelist <- match_meds_2(df = aurum_matches_df, 
                               medication_field = "Mood Stabiliser", 
...
#             file = paste0(wd, path_output, "Gold_Mood_Stabilisers_codelist_20250801.txt"),
#             sep = "\t", row.names = FALSE)
