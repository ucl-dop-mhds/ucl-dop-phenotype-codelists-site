# ==============================================================================
# Generate code lists for metformin anti-diabetic medications
# Author: SM Wu
...
#
# Inputs:
# 1) Code_Lists/MASTER_Lists/CPRD_Aur∂um_Product_10Feb2025.txt: Aurum product master code list
...
# 
# Final Outputs:
# 1) Code_Lists/Metformin/Aurum_Metformin_codelist_20250801.txt: Updated Aurum Metformin code list
# 2) Code_Lists/Metformin/Gold_Metformin_codelist_20250801.txt: Updated GOLD Metformin code list
# ==============================================================================
...
path_output <- "Code_Lists/Metformin/"
...
#             file = paste0(wd, path_output, "Aurum_Metformin_codelist_20250801.txt"),
#             sep = "\t", row.names = FALSE)
...
#             file = paste0(wd, path_output, "Gold_Metformin_codelist_20250801.txt"),
#             sep = "\t", row.names = FALSE)
